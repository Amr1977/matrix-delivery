...
\restrict NlGwhwX3BKnIWDIMAgy6WnGmgKW2aYcu5PU980bNGEEkwcZ3hG1XsXLW5ptbljo
...
ALTER TABLE IF EXISTS ONLY public.user_balances DROP CONSTRAINT IF EXISTS user_balances_frozen_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_assigned_driver_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.balance_transactions DROP CONSTRAINT IF EXISTS balance_transactions_wallet_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_transactions DROP CONSTRAINT IF EXISTS balance_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_transactions DROP CONSTRAINT IF EXISTS balance_transactions_related_transaction_id_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_transactions DROP CONSTRAINT IF EXISTS balance_transactions_processed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_transactions DROP CONSTRAINT IF EXISTS balance_transactions_order_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.balance_holds DROP CONSTRAINT IF EXISTS balance_holds_released_by_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_holds DROP CONSTRAINT IF EXISTS balance_holds_order_id_fkey;
...
DROP INDEX IF EXISTS public.idx_users_granted_roles;
...
DROP INDEX IF EXISTS public.idx_user_balances_last_transaction;
...
DROP INDEX IF EXISTS public.idx_messages_order;
...
DROP INDEX IF EXISTS public.idx_location_updates_order;
...
DROP INDEX IF EXISTS public.idx_driver_locations_driver_timestamp;
...
DROP INDEX IF EXISTS public.idx_balance_transactions_user_type_status;
DROP INDEX IF EXISTS public.idx_balance_transactions_user_type_created;
DROP INDEX IF EXISTS public.idx_balance_transactions_user_id;
DROP INDEX IF EXISTS public.idx_balance_transactions_user_created;
...
DROP INDEX IF EXISTS public.idx_balance_transactions_status;
DROP INDEX IF EXISTS public.idx_balance_transactions_order_id;
...
DROP INDEX IF EXISTS public.idx_balance_holds_order_id;
DROP INDEX IF EXISTS public.idx_balance_holds_order;
DROP INDEX IF EXISTS public.idx_balance_holds_hold_id;
DROP INDEX IF EXISTS public.idx_balance_holds_expires_at;
...
ALTER TABLE IF EXISTS ONLY public.driver_locations DROP CONSTRAINT IF EXISTS driver_locations_driver_id_key;
ALTER TABLE IF EXISTS ONLY public.delivery_agent_preferences DROP CONSTRAINT IF EXISTS delivery_agent_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.delivery_agent_preferences DROP CONSTRAINT IF EXISTS delivery_agent_preferences_agent_id_key;
...
ALTER TABLE IF EXISTS public.delivery_agent_preferences ALTER COLUMN id DROP DEFAULT;
...
DROP TABLE IF EXISTS public.users_backup_role_migration;
...
DROP SEQUENCE IF EXISTS public.delivery_agent_preferences_id_seq;
DROP TABLE IF EXISTS public.delivery_agent_preferences;
...
DROP TYPE IF EXISTS public.enum_reviews_review_type;
...
DROP TYPE IF EXISTS public.enum_bids_status;
...
--
-- Name: enum_bids_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: enum_reviews_review_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: TABLE balance_holds; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN balance_transactions.transaction_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN balance_transactions.balance_before; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN balance_transactions.balance_after; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE crypto_transactions; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: TABLE emergency_transfers; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN emergency_transfers.emergency_bonus; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN emergency_transfers.timeout_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN orders.upfront_payment; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN orders.escrow_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN orders.driver_distance_traveled_km; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN payments.paymob_transaction_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN payments.paymob_order_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE platform_revenue; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE takaful_claims; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.takaful_claims IS 'Benefit claims submitted by couriers';
...
--
-- Name: TABLE takaful_contributions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.takaful_contributions IS 'Per-order 5% contributions from courier deliveries';
...
--
-- Name: TABLE takaful_fund; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.takaful_fund IS 'Central Takaful cooperative insurance fund balance';
...
--
-- Name: TABLE takaful_loans; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.takaful_loans IS 'Interest-free gold-indexed loans to couriers';


--
-- Name: COLUMN takaful_loans.principal_gold_grams; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.takaful_loans.principal_gold_grams IS 'Loan amount in 24k gold grams for inflation protection';
...
--
-- Name: TABLE topup_audit_logs; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.topup_audit_logs IS 'Audit trail for admin actions on top-up requests';


--
-- Name: COLUMN topup_audit_logs.action; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.topup_audit_logs.action IS 'Admin action: verify, reject';


--
-- Name: COLUMN topup_audit_logs.details; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.topup_audit_logs.details IS 'Additional details about the action (JSON)';
...
--
-- Name: TABLE topups; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.topups IS 'User top-up requests requiring admin verification for Egypt payment methods';


--
-- Name: COLUMN topups.payment_method; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.topups.payment_method IS 'Payment method: vodafone_cash, orange_money, etisalat_cash, we_pay, instapay';


--
-- Name: COLUMN topups.transaction_reference; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.topups.transaction_reference IS 'Unique reference from the payment provider';


--
-- Name: COLUMN topups.status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.topups.status IS 'Request status: pending, verified, rejected';
...
--
-- Name: COLUMN users.available_cash; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: users_backup_role_migration; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences delivery_agent_preferences_agent_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: delivery_agent_preferences delivery_agent_preferences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_holds_expires_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_holds_order_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_transactions_order_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_transactions_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_transactions_user_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_transactions_user_type_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_balance_transactions_user_type_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_driver_locations_driver_timestamp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_location_updates_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_balances_last_transaction; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_granted_roles; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_balances user_balances_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: balance_holds balance_holds_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance_holds balance_holds_released_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance_transactions balance_transactions_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance_transactions balance_transactions_processed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance_transactions balance_transactions_related_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: balance_transactions balance_transactions_wallet_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: orders orders_assigned_driver_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_balances user_balances_frozen_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict NlGwhwX3BKnIWDIMAgy6WnGmgKW2aYcu5PU980bNGEEkwcZ3hG1XsXLW5ptbljo
