Feature: Full Order Flow E2E
  ...
  Scenario: Customer publishes order, driver bids, delivers, and both review
    ...
    And I exist as a customer with email "user@customer.com" and password "besmillah"
    And I exist as a driver with email "user@driver.com" and password "besmillah"

    # Customer creates order
    When I log in as "user@customer.com" with password "besmillah"
    ...
    # Driver places bid
    When I log in as "user@driver.com" with password "besmillah"
