Feature: Translation Testing
  ...
  Background:
    ...
    And I have a driver account "amr@driver.com" with password "***REDACTED***"
    And I have a customer account "amr@customer.com" with password "***REDACTED***"
  ...
  Scenario Outline: Driver dashboard translations in <language>
    Given I am logged in as driver "amr@driver.com" with password "***REDACTED***"
    When I switch to "<language>" language
  ...
  Scenario Outline: Customer dashboard translations in <language>
    Given I am logged in as customer "amr@customer.com" with password "***REDACTED***"
    When I switch to "<language>" language
