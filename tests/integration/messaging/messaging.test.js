...
describe('Messaging API Tests', () => {
    ...
    beforeAll(async () => {
       ...
       from_lat, from_lng, pickup_contact_name, to_lat, to_lng, dropoff_contact_name, price, status, customer_id, customer_name, assigned_driver_user_id, assigned_driver_name)
