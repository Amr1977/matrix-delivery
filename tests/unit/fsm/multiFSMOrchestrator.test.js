...
} = require("../../backend/fsm/MultiFSMOrchestrator");
...
describe("MultiFSMOrchestrator", () => {
  ...
  describe("Initialization", () => {
    ...
    test("should initialize FSMs with event emitters", () => {
      expect(multiFSMOrchestrator.fsms.vendor.eventEmitter).toBe(
        multiFSMOrchestrator.eventEmitter,
      );
      expect(multiFSMOrchestrator.fsms.payment.eventEmitter).toBe(
        multiFSMOrchestrator.eventEmitter,
      );
      expect(multiFSMOrchestrator.fsms.delivery.eventEmitter).toBe(
        multiFSMOrchestrator.eventEmitter,
      );
    });
  });
  ...
  describe("Order FSM Initialization", () => {
    ...
    test("should handle multiple order initializations", async () => {
      ...
      expect(states1.vendor).toBe(
        "awaiting_order_availability_vendor_confirmation",
      );
      expect(states2.vendor).toBe(
        "awaiting_order_availability_vendor_confirmation",
      );
    });
  });
  ...
  describe("Error Handling", () => {
    test("should handle database errors gracefully", async () => {
      ...
      multiFSMOrchestrator.saveFSMState = jest
        .fn()
  ...
  describe("Concurrency Handling", () => {
    test("should handle concurrent transitions safely", async () => {
      ...
      const promises = [
        multiFSMOrchestrator.executeFSMTransition(
          orderId,
          "vendor",
          "vendor_confirms_order_is_available",
          context,
