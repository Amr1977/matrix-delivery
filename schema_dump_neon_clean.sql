...
DROP TYPE IF EXISTS public.enum_bids_status CASCADE;
...
DROP TYPE IF EXISTS public.enum_payments_payment_method CASCADE;
...
DROP TYPE IF EXISTS public.enum_payments_status CASCADE;
...
DROP TYPE IF EXISTS public.enum_reviews_review_type CASCADE;
...
DROP FUNCTION IF EXISTS public.cleanup_old_health_logs() CASCADE;
...
DROP FUNCTION IF EXISTS public.update_balance_transaction_timestamp() CASCADE;
...
DROP FUNCTION IF EXISTS public.update_wallet_payment_timestamp() CASCADE;
