...
const MatrixLanding: React.FC = () => {
  ...
  return (
    <div className="bg-[#0A0E14] min-h-screen font-sans text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[#00FF41] text-xs font-mono tracking-widest">
                PLATFORM
              </p>
            </div>
          </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-block px-4 py-1 bg-[#00FF41]/10 border border-[#00FF41] rounded-full mb-8 animate-pulse">
            <span className="text-[#00FF41] text-sm font-semibold tracking-wider uppercase">
              {t("landing.evolutionBadge")}
            </span>
          </div>
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <button
              onClick={() => navigate("/reviews")}
              className="px-8 py-4 bg-[#131820] text-white font-bold rounded-lg text-lg border border-[#2A3142] hover:border-[#00FF41] hover:text-[#00FF41] transition-all flex items-center gap-2"
            >
      ...
      <section
        id="vision"
        className="py-20 bg-[#0F1419] border-y border-[#1E293B]"
      >
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              <RoadmapStep
                ...
                title={t("landing.heroTitle").split(".")[0] + "."}
                status={t("landing.statusCompleted")}
                date="Q1 2025"
              />
              <RoadmapStep
                phase={t("landing.phase2")}
                title={t("landing.vision")}
              ...
              <RoadmapStep
                ...
                title={t("landing.visionFreedom")}
                status={t("landing.statusUpcoming")}
                date="Q4 2025"
              />
              <RoadmapStep
                phase={t("landing.phase4")}
                title="The Source"
                status={t("landing.statusPlanned")}
                date="2026"
              />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00FF41] transition-colors">
              ...
              <p className="text-[#00FF41] text-xs mt-2 flex items-center gap-1">
                <Shield className="w-3 h-3" /> {t("landing.licensed")}
              </p>
            </div>
            ...
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#F0F0FF] transition-colors">
              ...
              <p className="text-[#F0F0FF] text-xs mt-2 flex items-center gap-1">
                <Users className="w-3 h-3" /> {t("landing.growing")}
              </p>
            </div>
            ...
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#FFB800] transition-colors">
              ...
              <p className="text-[#FFB800] text-xs mt-2 flex items-center gap-1">
                <Package className="w-3 h-3" /> {t("landing.partners")}
              </p>
            </div>
            ...
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00F0FF] transition-colors">
              <p className="text-[#A0AEC0] text-sm mb-1">
                {t("landing.deliveries")}
              </p>
              <p className="text-3xl font-mono text-white font-bold">
                {stats.totalDeliveries.toLocaleString()}
              </p>
              <p className="text-[#00F0FF] text-xs mt-2 flex items-center gap-1">
                <Truck className="w-3 h-3" /> {t("landing.lifetime")}
              </p>
            </div>
            ...
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#B026FF] transition-colors">
              ...
              <p className="text-[#B026FF] text-xs mt-2 flex items-center gap-1">
                <Activity className="w-3 h-3" /> {t("landing.online")}
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Open Source Section */}
      <section className="py-20 border-t border-[#2A3142] bg-[#0A0E14]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-[#00F0FF]/10 text-[#00F0FF] text-sm font-mono mb-4">
              Open Source
            </span>
            <h2 className="text-4xl font-bold mb-4">
              Built Together, Run Together
            </h2>
            <p className="text-[#A0AEC0] max-w-2xl mx-auto">
              Matrix Delivery is open source. Join developers, drivers, and
              contributors building the fairest delivery platform in the world.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00F0FF] transition-colors text-center">
              <GitBranch className="w-12 h-12 text-[#00F0FF] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Contribute</h3>
              <p className="text-[#A0AEC0] text-sm">
                Fork the repo, fix bugs, add features. PRs welcome.
              </p>
            </div>
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00FF41] transition-colors text-center">
              <Shield className="w-12 h-12 text-[#00FF41] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Fair Code</h3>
              <p className="text-[#A0AEC0] text-sm">
                90% to drivers. Transparent fees. No hidden costs.
              </p>
            </div>
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#B026FF] transition-colors text-center">
              <Users className="w-12 h-12 text-[#B026FF] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Join Community</h3>
              <p className="text-[#A0AEC0] text-sm">
                Connect with developers and drivers worldwide.
              </p>
            </div>
          </div>
          <div className="text-center">
            <a
              href="https://github.com/Amr1977/matrix-delivery"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#00F0FF] text-black font-bold rounded-lg hover:bg-[#00F0FF]/90 transition-colors"
            >
      ...
      {/* Donation Section */}
      <section className="py-20 border-t border-[#2A3142] bg-[#0D1117]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-[#00FF41]/10 text-[#00FF41] text-sm font-mono mb-4">
              Support
            </span>
            <h2 className="text-4xl font-bold mb-4">Support the Mission</h2>
            <p className="text-[#A0AEC0] max-w-2xl mx-auto">
              Help us keep the platform running and fair. Every contribution
              matters.
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00FF41] transition-colors text-center">
              ...
              <a
                href="https://github.com/sponsors/Amr1977"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#00F0FF] text-sm hover:underline"
              >
                github.com/sponsors/Amr1977
              </a>
            </div>
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#00F0FF] transition-colors text-center">
              <Package className="w-12 h-12 text-[#00F0FF] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">PayPal</h3>
              <p className="text-[#A0AEC0] text-sm">
                amr.lotfy.othman@gmail.com
              </p>
            </div>
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#B026FF] transition-colors text-center">
              <Lock className="w-12 h-12 text-[#B026FF] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Crypto (TRC20)</h3>
              <p className="text-[#A0AEC0] text-xs font-mono break-all">
                TACcgwLC4GeKzKGLWz14tiVahnpftHre1H
              </p>
            </div>
            <div className="bg-[#131820] p-6 rounded-xl border border-[#2A3142] hover:border-[#FF6B6B] transition-colors text-center">
              <Zap className="w-12 h-12 text-[#FF6B6B] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">InstaPay</h3>
              <p className="text-[#A0AEC0] text-sm">01094450141</p>
            </div>
          </div>
          <p className="text-center text-[#64748B] text-sm">
            Thank you for supporting fair delivery work!
          </p>
        </div>
      </section>
...
const VisionCard: React.FC<VisionCardProps> = ({
  ...
  <div
    className="bg-[#131820] p-8 rounded-2xl border border-[#2A3142] hover:border-[color:var(--hover-color)] transition-all hover:-translate-y-2 group"
    style={{ "--hover-color": color } as React.CSSProperties}
  >
    <div
      className="w-16 h-16 rounded-xl bg-[#0A0E14] border border-[#2A3142] flex items-center justify-center mb-6 group-hover:shadow-lg transition-shadow"
...
const RoadmapStep: React.FC<RoadmapStepProps> = ({
  ...
  <div
    className={`bg-[#131820] p-6 rounded-xl border ${active ? "border-[#00FF41] shadow-[0_0_15px_rgba(0,255,65,0.2)]" : "border-[#2A3142]"} text-left`}
  >
    <div className="flex justify-between items-start mb-4">
      <span
        className={`text-xs font-mono px-2 py-1 rounded ${active ? "bg-[#00FF41]/20 text-[#00FF41]" : "bg-[#2A3142] text-[#A0AEC0]"}`}
      >
        {status}
      </span>
