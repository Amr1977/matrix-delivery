  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      const [statsData, usersData, ordersData, vcData] = await Promise.all([
        ...
        api.get(
          `/admin/users?page=${usersPage}&limit=${itemsPerPage}&search=${encodeURIComponent(searchQuery)}${roleParam ? "&primary_role=" + roleParam : ""}`,
        ),
  ...
  const fetchLogs = useCallback(async () => {
    try {
      ...
      const data = await api.get(
        `/admin/logs?page=${logsPage}&limit=50&type=${logsType}`,
      );
  ...
  return (
    ...
    >
      ...
      <header
        style={{
          background:
            "linear-gradient(135deg, var(--matrix-black) 0%, var(--matrix-dark-green) 100%)",
          color: "var(--matrix-bright-green)",
          padding: "1rem 2rem",
      ...
      >
        ...
        {activeTab === "payments-withdrawals" && (
          <div>
            <AdminWithdrawalsPanel
              onPendingCountChange={setPendingWithdrawalCount}
            />
          </div>
        )}

        {activeTab === "payments-wallets" && <AdminWalletsPanel />}
            ...
            <div className="card" style={{ marginBottom: "1.5rem" }}>
              ...
              <div style={{ display: "flex", gap: "1rem" }}>
                ...
                >
                  ...
                  >
                    {(displayStats.usersByRole?.customer || 0).toLocaleString()}
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {(displayStats.usersByRole?.driver || 0).toLocaleString()}
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {userCounts.totalVerified != null
                      ? userCounts.totalVerified.toLocaleString()
                      : "—"}
                  </p>
                </div>
              </div>
                    ...
                    users.map((user) => (
                      ...
                      >
                        ...
                        <td style={{ padding: "1rem" }}>
                          ...
                          >
                            <span
                              style={{ color: "#FCD34D", fontSize: "1rem" }}
                            >
                              ★
                            </span>
                            <span
                        ...
                        <td style={{ padding: "1rem" }}>
                          ...
                          >
                            ...
                            <button
                              onClick={() => {
                                const isAdmin = (
                                  user.granted_roles || [user.primary_role]
                                ).includes("admin");
                                updateUserRoles(
                                  user.id,
                                  isAdmin
            ...
            >
              ...
              >
                {[
                  ...
                  const count =
                    (displayStats.ordersByStatus || []).find(
                      (s) => s.name === card.label,
                    )?.value || 0;
                  return (
                    <div
                    ...
                    {loading ? (
                      ...
                      orders.map((order) => {
                        const statusColors = {
                          ...
                          courier_delivered: { bg: "#D1FAE5", text: "#065F46" },
                          customer_delivered: {
                            bg: "#A7F3D0",
                            text: "#064E3B",
                          },
                            ...
                            <td style={{ padding: "1rem" }}>
                              <span
                                style={{
                                  ...
                                  fontWeight: "600",
                                  background:
                                    statusColors[order.status]?.bg || "#F3F4F6",
                                  color:
              ...
              {ordersPagination && (
                ...
                >
                  <button
                    ...
                    onClick={() => setOrdersPage(ordersPagination.page - 1)}
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ${(displayStats.metrics?.avgOrderValue || 0).toFixed(2)}
                      </span>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {(displayStats.metrics?.completionRate || 0).toFixed(1)}
                        %
                      </span>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        {(displayStats.metrics?.avgDeliveryTime || 0).toFixed(
                          2,
                        )}{" "}
                        hrs
                      </span>
                    ...
                    >
                      ...
                      >
                        {(displayStats.metrics?.avgRating || 0).toFixed(2)}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        {activeTab === "logs" && <LogsViewer apiUrl={API_URL} />}
