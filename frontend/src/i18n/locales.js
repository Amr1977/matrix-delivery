const translations = {
  "en": {
    ...
    "system": {
      ...
      "unrecoverableException": "The system has encountered an unrecoverable exception.",
    ...
    "balance": {
      ...
      "frozenMessage": "Your balance is currently frozen. Please contact support.",
      ...
      "debt": "Debt",
      "lowBalanceWarning": "⚠️ Your balance is low. Please deposit funds to continue accepting orders.",
      "blockedWarning": "🚫 You cannot accept new orders until your balance is above -200 EGP.",
    ...
    "withdrawal": {
      ...
      "processingNotice": "Withdrawal requests are usually processed within 24-48 hours.",
      "enterVerificationCode": "Enter Verification Code",
      "verificationInstructions": "We sent a 6-digit verification code to your email. Enter it below to confirm your withdrawal.",
      ...
      "enterVerificationCodeError": "Please enter the 6-digit verification code sent to your email"
    },
    "transactionHistory": {
    ...
    "profile": {
      ...
      "financialsNote": "* You must have enough balance to cover upfront payments for cash orders.",
    ...
    "reviews": {
      ...
      "reportSuccess": "Review reported. Thank you for keeping the community safe.",
    ...
    "landing": {
      ...
      "visionFreedomDesc": "Break free from traditional logistics constraints. Delivery without borders.",
      "visionJustice": "Justice",
      "visionJusticeDesc": "Fair wages for couriers. Fair prices for customers. No hidden fees.",
      "visionEfficiency": "Efficiency",
      "visionEfficiencyDesc": "AI-optimized routing ensures the fastest possible delivery times.",
      "visionTransparency": "Transparency",
      "visionTransparencyDesc": "Open source protocols. Real-time tracking. Verify everything.",
  ...
  "ar": {
    ...
    "balance": {
      ...
      "platformCommission": "🏢 عمولة المنصة (15%)",
      "netEarnings": "✅ صافي الأرباح",
      "currentBalance": "💰 الرصيد الحالي",
      "debt": "مديونية",
      "lowBalanceWarning": "⚠️ رصيدك منخفض. يرجى الإيداع للاستمرار في قبول الطلبات.",
      "blockedWarning": "🚫 لا يمكنك قبول طلبات جديدة حتى يصبح رصيدك أعلى من -200 جنيه.",
    ...
    "withdrawal": {
      ...
      "verificationInstructions": "أرسلنا رمز تحقق مكون من 6 أرقام إلى بريدك الإلكتروني. أدخله أدناه لتأكيد السحب.",
      ...
      "enterVerificationCodeError": "يرجى إدخال رمز التحقق المكون من 6 أرقام المرسل إلى بريدك الإلكتروني"
    },
    "transactionHistory": {
      "title": "📊 سجل المعاملات",
      "exportCSV": "تصدير CSV",
    ...
    "profile": {
      ...
      "financialsNote": "* يجب أن يكون لديك رصيد كافٍ لتغطية الدفعات المقدمة للطلبات النقدية.",
    ...
    "landing": {
      ...
      "heroSubtitle": "أول شبكة خدمات لوجستية لامركزية في العالم مدعومة من الناس ولأجل الناس. جرب حرية التوصيل المباشر.",
      "cta": "ابدأ الآن",
      ...
      "visionFreedomDesc": "تحرر من قيود الخدمات اللوجستية التقليدية. توصيل بلا حدود.",
      "visionJustice": "العدالة",
      "visionJusticeDesc": "أجور عادلة للسعاة. أسعار عادلة للعملاء. لا رسوم خفية.",
      "visionEfficiency": "الاحترافية",
      "visionEfficiencyDesc": "يضمن التوجيه المحسن بالذكاء الاصطناعي أسرع أوقات توصيل ممكنة.",
      "visionTransparency": "الشفافية",
      "visionTransparencyDesc": "بروتوكولات مفتوحة المصدر. تتبع في الوقت الحقيقي. تحقق من كل شيء.",
